...
I started learning HTML and CSS last year around February/March.
This year, I started learning JavaScript. This felt more my wheelhouse as it is focused more on functionality than on design.

In this version, I apply HTML, CSS, and JavaScript - I use some css variables <3 media query, flexbox <3, and simple JavaScript (eventListeners and such).
